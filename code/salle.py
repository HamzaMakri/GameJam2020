...
def attaque(coeurpris, bombonnepris):
    ...
    if left and space:
        koopa = pygame.image.load("magicienGaucheAtk.png")
        menu.blit(koopa, position_perso)
        vent = pygame.image.load("VentGauche.png")
        ...
        koopa = pygame.image.load("magicienGauche.png")
        menu.blit(koopa, position_perso)



    if right and space:
        koopa = pygame.image.load("magicienDroiteAtk.png")
        menu.blit(koopa, position_perso)
        ...
        space = False
        vent = pygame.image.load("Vide.png")
        koopa = pygame.image.load("magicienDroite.png")
        menu.blit(koopa, position_perso)
...
def salle1(x,y):
    ...
    while continuer:
        ...
        if position_vent.x == position_ennemi.x and position_vent.y == position_ennemi.y:
            print("ennemi touché")
            ennemi = pygame.image.load("ennemieGauche.png")
